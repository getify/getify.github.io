...
/*	var wtfs = [
		...
		"[undefined]_String(x)",
		"[undefined]_x + ''",
		"[undefined]_x.toString()",
		"[undefined]_Number(x), +x",
		"[undefined]_x + 0",
		"[undefined]_x * 1",
		...
		"[Infinity]_String(x)",
		"[Infinity]_x + ''",
		"[Infinity]_x.toString()",
		"[Infinity]_Number(x), +x",
		"[Infinity]_x + 0",
		"[Infinity]_x * 1",
		...
		"[function(){}]_String(x)",
		"[function(){}]_x + ''",
		"[function(){}]_x.toString()",
		"[function(){}]_Number(x), +x",
		"[function(){}]_x + 0",
		"[function(){}]_x * 1",
...
/*	$( "[rel=\"" + wtfs.join("\"],[rel=\"") + "\"]" )
	.addClass("wtf")
	.each(function(){
		$(this).attr("title","WTF!? : " + $(this).attr("title"));
	});*/
